                ...
                <div className="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        ...
                        <div className="space-y-6">
                            <div className="items-center">
                                ...
                                <img src="/logo.svg" alt="Hero Image" className="relative lg:-mx-9 md:mx-aut />
                            </div>

                            <div className="text-sm leading-relaxed">
                                +01 234 567 8910<br />
                                arshakir@gmail.com<br />
                    ...
                    <div className="flex flex-col md:flex-row-reverse md:justify-between space-y-6 md:space-y-0 text-center md:text-left text-sm">
                        ...
                        <div className="text-gray-500">
                            <span className="font-medium">© Copyright 2023 ByteOski All rights reserved.</span>
                        </div>
                    </div>
                </div>
            </footer>
